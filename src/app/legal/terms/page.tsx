    ...
    <div className="mx-auto max-w-2xl px-6 py-16">
      ...
      <div className="mt-6 flex flex-col gap-6 text-sm text-muted">
        <section>
          ...
          <p>
            By creating an account or subscribing, you agree to these Terms of
            Service. If you do not agree, do not use DollarWatch.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>
            You agree not to scrape, resell, or redistribute data from this
            service, or to use it in a way that violates applicable law.
          </p>
        </section>
        <section>
          <h2 className="mb-2 text-foreground">4. Limitation of liability</h2>
          <p>
            DollarWatch is provided &quot;as is&quot; without warranties of
            any kind. To the maximum extent permitted by law, DollarWatch is
            not liable for any indirect, incidental, or consequential
            damages, including trading losses, arising from your use of this
            service.
          </p>
        </section>
        <section>
