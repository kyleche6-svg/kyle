...
export default async function StocksPage({
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-8">
      <PageHeader
        title="Stocks"
        description="Search any ticker. Live prices with real third-party analyst consensus data — Buy/Hold/Sell counts and price targets as reported by analysts, not generated by DollarWatch."
      />
